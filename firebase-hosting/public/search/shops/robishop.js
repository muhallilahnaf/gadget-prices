...
const checkPaginationRobishop = (text) => {
    let links = []
...
const parseTextRobishop = (text, isSecondary) => {
    ...
    parseRobishop(JSON.parse(text))
    if (!isSecondary) {
        urls = checkPaginationRobishop(text)
    }
    return urls
}
